...
import com.oracle.citiccloud.model.PaymentDetail;
...
public class BillDetail   {
  @JsonProperty("items")
  private List<PaymentDetail> items = null;

  public BillDetail items(List<PaymentDetail> items) {
    this.items = items;
    return this;
  }

  public BillDetail addItemsItem(PaymentDetail itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<PaymentDetail>();
    }
  ...
  **/
  ...
  public void setItems(List<PaymentDetail> items) {
    this.items = items;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, billDetail.items);
  }
