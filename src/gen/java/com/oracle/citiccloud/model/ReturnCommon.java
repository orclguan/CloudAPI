...
public class ReturnCommon   {
  ...
  public ReturnCommon code(Integer code) {
    this.code = code;
    return this;
  }

   /**
   * 0 表示成功，或有效， 非0表示失败，失败信息应在message里体现。
   * @return code
  **/
  @JsonProperty("code")
  @ApiModelProperty(value = "0 表示成功，或有效， 非0表示失败，失败信息应在message里体现。")
  ...
  public ReturnCommon message(String message) {
  ...
  **/
  @JsonProperty("message")
  @ApiModelProperty(value = "与 code 对应的信息。")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReturnCommon returnCommon = (ReturnCommon) o;
    return Objects.equals(this.code, returnCommon.code) &&
        Objects.equals(this.message, returnCommon.message);
  }
